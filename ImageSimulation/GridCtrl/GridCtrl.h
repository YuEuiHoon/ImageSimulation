...
public:
    ...
    long SendMessageToParent(int nRow, int nCol, int nMessage) const;
    long SendDisplayRequestToParent(GV_DISPINFO* pDisplayInfo) const;
    long SendCacheHintToParent(const CCellRange& range) const;
